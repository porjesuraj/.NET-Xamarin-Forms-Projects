...
{
    public class ArticleDetailsPageViewModel : ViewModelBase, IQueryAttributable
    {
        ...
        public void ApplyQueryAttributes(IDictionary<string, string> query)
        {
            ...
            {
                Title = HttpUtility.UrlDecode(query["title"]),
                Description = HttpUtility.UrlDecode(query["description"]),
                UrlToImage = HttpUtility.UrlDecode(query["urlToImage"]),
                Url = HttpUtility.UrlDecode(query["url"]),
                PublishedAt = DateTime.Parse(HttpUtility.UrlDecode(query["published"]))
            
        };
            ArticleDetails = article;
          /*  ArticleDetails.Title = HttpUtility.UrlDecode(query["title"]);
            ArticleDetails.Description = HttpUtility.UrlDecode(query["description"]);
           // ArticleDetails.Source.Name = HttpUtility.UrlDecode(query["source"]);
           ArticleDetails.UrlToImage = HttpUtility.UrlDecode(query["urlToImage"]);
            ArticleDetails.Url = HttpUtility.UrlDecode(query["url"]);
            ArticleDetails.PublishedAt = DateTime.Parse( HttpUtility.UrlDecode(query["published"]));*/
